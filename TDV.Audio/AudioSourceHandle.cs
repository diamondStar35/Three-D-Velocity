...
namespace TDV.Audio
{
    ...
    public sealed class AudioSourceHandle : IDisposable
    {
        ...
        public AudioSourceHandle(AudioOutput output, string filePath, bool streamFromDisk)
        {
            _output = output;
            _sound = new MaSound();
            ...
            _useHrtf = _output.SteamAudio != null;
        ...
        internal AudioSourceHandle(AudioOutput output, MaSound sound, bool ownsSound, IDisposable? userData = null)
        {
            _output = output;
